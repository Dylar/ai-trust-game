...
extension ApiErrorLocalizations on AppLocalizations {
  String apiErrorDescription(ApiErrorCode? code) {
    return switch (code) {
      ...
      ApiErrorCode.duplicateUserDisplayName => apiErrorDuplicateUserDisplayName,
      ApiErrorCode.invalidUserDisplayName => apiErrorInvalidUserDisplayName,
      ApiErrorCode.missingUserDisplayName => apiErrorMissingUserDisplayName,
